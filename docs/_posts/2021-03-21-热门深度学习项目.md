...
| 项目名称 | Stars | 简介 |
| ------- | ------ | ------ |
|[tensorflow](https://github.com/tensorflow/tensorflow)|146k|开源深度学习框架|
|[keras](https://github.com/keras-team/keras)|48.9k|更加人性化的深度学习框架|
|[opencv](https://github.com/opencv/opencv)|46.1k|开源计算机视觉库|
|[pytorch](https://github.com/pytorch/pytorch)|40k|动态神经网库|
|[TensorFlow-Examples](https://github.com/aymericdamien/TensorFlow-Examples)|38.1k|TensorFlow初学者教程和示例（支持TF v1和v2）。|
|[tesseract](https://github.com/tesseract-ocr/tesseract)|35.3k|Tesseract开源OCR引擎(主库)|
|[face_recognition](https://github.com/ageitgey/face_recognition)|35.2k|世界上最简单的Python和命令行的面部识别api。|
|[faceswap](https://github.com/deepfakes/faceswap)|31.4k|人人都能使用的Deepfakes软件|
|[transformers](https://github.com/huggingface/transformers)|30.4k|🤗Transformers: 最先进的自然语言处理库支持 Pytorch 和TensorFlow 2.0.|
|[100-Days-Of-ML-Code](https://github.com/Avik-Jain/100-Days-Of-ML-Code)|29.1k|100 Days of ML Coding|
|[julia](https://github.com/JuliaLang/julia)|28.1k|Julia 语言。一种全新的技术计算方法。|
|[gold-miner](https://github.com/xitu/gold-miner)|26.6k|🥇掘金翻译计划，可能是世界最大最好的英译中技术社区，最懂读者和译者的翻译平台：|
|[awesome-scalability](https://github.com/binhnguyennus/awesome-scalability)|26.6k|可扩展、可靠和高性能的大规模系统的模式。|
|[basics](https://github.com/madewithml/basics)|24.5k|📚 通过简洁的代码、简化的数学和说明性的视觉效果来学习ML。|
|[bert](https://github.com/google-research/bert)|23.9k|BERT的TensorFlow代码和预训练模型。|
...
|[xgboost](https://github.com/dmlc/xgboost)|19.4k|可扩展、可移植、分布式梯度提升（GBDT、GBRT或GBM）库，适用于Python、R、Java、Scala、C++等。可在单机、Hadoop、Spark、Flink和DataFlow上运行。|
|[Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)|18.4k|5秒内克隆语音，实时生成任意语音。|
|[d2l-zh](https://github.com/d2l-ai/d2l-zh)|17.9k|《动手学深度学习》：面向中文读者、能运行、可讨论。英文版即伯克利“深度学习导论”教材。|
|[openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose)|17.8k|OpenPose。用于身体、脸部、手部和脚部估算的实时多人关键点检测库。|
|[Coursera-ML-AndrewNg-Notes](https://github.com/fengdu78/Coursera-ML-AndrewNg-Notes)|17.7k|吴恩达老师的机器学习课程个人笔记|
|[DeepFaceLab](https://github.com/iperov/DeepFaceLab)|17.3k|DeepFaceLab是创建深层假面的领先软件。|
|[pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial)|17.3k|深度学习研究人员的PyTorch教程|
|[Mask_RCNN](https://github.com/matterport/Mask_RCNN)|17.2k|基于Keras和TensorFlow的对象检测和实例分割的Mask R-CNN|
|[spaCy](https://github.com/explosion/spaCy)|16.8k|💫 使用Python和Cython进行工业强度的自然语言处理（NLP）。|
|[NLP-progress](https://github.com/sebastianruder/NLP-progress)|16.2k|追踪自然语言处理（NLP）进展的存储库，包括最常见的NLP任务的数据集和当前最先进的技术。|
...
|[convnetjs](https://github.com/karpathy/convnetjs)|10k|在Javascript中进行深度学习。在浏览器中训练卷积神经网络（或普通神经网络）。|
...
|[Learn_Machine_Learning_in_3_Months](https://github.com/llSourcell/Learn_Machine_Learning_in_3_Months)|7.3k|这是Siraj Raval在Youtube上发表的《3个月学会机器学习》的代码。|
...
|[iGAN](https://github.com/junyanz/iGAN)|3.7k|通过生成式对抗网络生成交互式图像|
...
|[computervision-recipes](https://github.com/microsoft/computervision-recipes)|2.9k|计算机视觉的最佳实践、代码示例和文档。|
...
|[BERT-BiLSTM-CRF-NER](https://github.com/macanv/BERT-BiLSTM-CRF-NER)|2.9k|Tensorflow解决NER任务使用BiLSTM-CRF模型与Google BERT微调和私有服务器服务。|
...
|[DeepLearning](https://github.com/yusugomori/DeepLearning)|2.8k|深度学习 (Python, C, C++, Java, Scala, Go)|
...
|[pygcn](https://github.com/tkipf/pygcn)|2.7k|在PyTorch中的图卷积网络。|
...
|[PyTorchNLPBook](https://github.com/joosthub/PyTorchNLPBook)|1.1k|O'Reilly Media出版的《用PyTorch进行自然语言处理》附带的代码和数据：https://nlproc.info。|
|[mtcnn](https://github.com/ipazc/mtcnn)|1.1k|TensorFlow的MTCNN人脸检测实现，作为一个PIP包。|
...
|[tensorflow-fcn](https://github.com/MarvinTeichmann/tensorflow-fcn)|1.1k|在Tensorflow中实现完全卷积网络的方法 |
...
|[tfx](https://github.com/tensorflow/tfx)|1.1k|TFX是一个部署生产ML管道的端到端平台。|
|[handwriting-synthesis](https://github.com/sjvasquez/handwriting-synthesis)|1.1k|用RNNs合成手写体 ✏️|
...
|[CRNN_Chinese_Characters_Rec](https://github.com/Sierkinhane/CRNN_Chinese_Characters_Rec)|1k|(CRNN)汉字识别。|
|[hmtl](https://github.com/huggingface/hmtl)|1k|🌊HMTL：分层多任务学习--基于PyTorch和AllenNLP的多个NLP任务的最先进的神经网络模型。|
|[rethinking-network-pruning](https://github.com/Eric-mingjie/rethinking-network-pruning)|1k|反思网络修剪的价值(Pytorch)(ICLR 2019)|
|[pytorch-classification](https://github.com/bearpaw/pytorch-classification)|1k|用PyTorch进行分类。|
|[a-PyTorch-Tutorial-to-Image-Captioning](https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Image-Captioning)|1k|展示、出席和讲述｜图片字幕的 PyTorch 教程|
|[reformer-pytorch](https://github.com/lucidrains/reformer-pytorch)|1k|Reformer高效率的 Transformer, in Pytorch|
...
|[open-reid](https://github.com/Cysu/open-reid)|1k|开源的Python人名重新识别库|
|[wgan-gp](https://github.com/caogang/wgan-gp)|1k|论文 "Wasserstein GANs的改进训练 "的pytorch实现。|
